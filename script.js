document.addEventListener('DOMContentLoaded', function() {
    ...
    sliders.forEach(slider => {
        ...
        if (slideCount === 8) {
            slidesPerViewDesktop = 4; // ถ้ามี 8 ให้แสดงแถวละ 4
        } else if (slideCount === 6) {
            slidesPerViewDesktop = 3; // ถ้ามี 6 ให้แสดงแถวละ 3
        } else if (slideCount === 5) {
            slidesPerViewDesktop = 4; // ถ้ามี 5 ให้แสดงแถวละ 4 (และเลื่อนดูได้)
        } else if (slideCount === 4) {
            slidesPerViewDesktop = 4; // ถ้ามี 4 ให้แสดงแถวละ 4
